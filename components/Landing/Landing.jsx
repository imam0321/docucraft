          ...
          <div className=" relative mx-auto px-4 ">
            <div className="mx-auto grid max-w-[40rem] grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-5">
              ...
              <div className="relative lg:col-span-3">
                <Image src="/banner.png" width="600" height="480"
                  className="relative z-20 -mb-36 aspect-[853/682] min-w-[300px] rounded-xl bg-slate-200 shadow-xl shadow-black/5 ring-1 ring-slate-900/5 sm:-mb-16 lg:-mb-8 xl:-mb-16" alt="banner" />
              </div>
            </div>
          </div>
        </div>
